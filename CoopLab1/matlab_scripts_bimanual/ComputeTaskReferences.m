...
% e.g. CartError(wTg, wTv) returns the error that makes <v> -> <g> 
        ...
        pandaArms.ArmL.xdot.pose = 0.9 * [ang; lin];
            % limit the requested velocities...
        pandaArms.ArmL.xdot.pose(1:3) = Saturate(pandaArms.ArmL.xdot.pose(1:3), 0.9);
        pandaArms.ArmL.xdot.pose(4:6) = Saturate(pandaArms.ArmL.xdot.pose(4:6), 0.9);
        ...
        pandaArms.ArmR.xdot.pose = 0.9 * [ang; lin];
            % limit the requested velocities...
    ...
    case 2
        ...
        pandaArms.ArmL.xdot.bimanualPose = 0.9 * [ang; lin]; % limit the requested velocities...
        ...
        pandaArms.ArmR.xdot.bimanualPose = 0.9 * [ang; lin]; % limit the requested velocities...
